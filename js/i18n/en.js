...
export const en = {
  ...
  settings: {
    ...
    export: 'Export JSON',
    import: 'Import JSON',
    importPh: 'Paste here the JSON you exported before…',
    importFile: 'Choose file',
    importLoad: 'Load data',
    importCancel: 'Cancel',
    wipe: 'Delete all',
    toolsTitle: 'Tools',
  ...
  create: {
    ...
    kind: { quit: 'Quit something', build: 'Build something' },
    modeLabel: 'Mode',
    mode: { auto: 'Automatic', manual: 'Manual' },
    modeHint: { auto: 'Adds a day on its own when the date changes.', manual: 'You add days by hand whenever you want, with a +1 button.' },
    nameLabel: 'Name',
  ...
  toast: {
    ...
    importOk: '{n} counters loaded.',
    importFail: 'Invalid JSON. Check what you pasted.',
